...
#if defined(VGPU_D3D11_DRIVER) && defined(TODO)
...
namespace
{
    ...
    static_assert(sizeof(VGPUViewport) == sizeof(D3D11_VIEWPORT));
    static_assert(offsetof(VGPUViewport, x) == offsetof(D3D11_VIEWPORT, TopLeftX));
    static_assert(offsetof(VGPUViewport, y) == offsetof(D3D11_VIEWPORT, TopLeftY));
    static_assert(offsetof(VGPUViewport, width) == offsetof(D3D11_VIEWPORT, Width));
    static_assert(offsetof(VGPUViewport, height) == offsetof(D3D11_VIEWPORT, Height));
    static_assert(offsetof(VGPUViewport, minDepth) == offsetof(D3D11_VIEWPORT, MinDepth));
    static_assert(offsetof(VGPUViewport, maxDepth) == offsetof(D3D11_VIEWPORT, MaxDepth));

    static_assert(sizeof(VGPUDispatchIndirectCommand) == sizeof(uint32_t) * 3, "DispatchIndirectCommand mismatch");
    static_assert(offsetof(VGPUDispatchIndirectCommand, x) == sizeof(uint32_t) * 0, "Layout mismatch");
    static_assert(offsetof(VGPUDispatchIndirectCommand, y) == sizeof(uint32_t) * 1, "Layout mismatch");
    static_assert(offsetof(VGPUDispatchIndirectCommand, z) == sizeof(uint32_t) * 2, "Layout mismatch");

    static_assert(sizeof(VGPUDrawIndirectCommand) == sizeof(D3D11_DRAW_INSTANCED_INDIRECT_ARGS), "DrawIndirectCommand mismatch");
    static_assert(offsetof(VGPUDrawIndirectCommand, vertexCount) == offsetof(D3D11_DRAW_INSTANCED_INDIRECT_ARGS, VertexCountPerInstance), "Layout mismatch");
    static_assert(offsetof(VGPUDrawIndirectCommand, instanceCount) == offsetof(D3D11_DRAW_INSTANCED_INDIRECT_ARGS, InstanceCount), "Layout mismatch");
    static_assert(offsetof(VGPUDrawIndirectCommand, firstVertex) == offsetof(D3D11_DRAW_INSTANCED_INDIRECT_ARGS, StartVertexLocation), "Layout mismatch");
    static_assert(offsetof(VGPUDrawIndirectCommand, firstInstance) == offsetof(D3D11_DRAW_INSTANCED_INDIRECT_ARGS, StartInstanceLocation), "Layout mismatch");

    static_assert(sizeof(VGPUDrawIndexedIndirectCommand) == sizeof(D3D11_DRAW_INDEXED_INSTANCED_INDIRECT_ARGS), "DrawIndexedIndirectCommand mismatch");
    static_assert(offsetof(VGPUDrawIndexedIndirectCommand, indexCount) == offsetof(D3D11_DRAW_INDEXED_INSTANCED_INDIRECT_ARGS, IndexCountPerInstance), "Layout mismatch");
    static_assert(offsetof(VGPUDrawIndexedIndirectCommand, instanceCount) == offsetof(D3D11_DRAW_INDEXED_INSTANCED_INDIRECT_ARGS, InstanceCount), "Layout mismatch");
    static_assert(offsetof(VGPUDrawIndexedIndirectCommand, firstIndex) == offsetof(D3D11_DRAW_INDEXED_INSTANCED_INDIRECT_ARGS, StartIndexLocation), "Layout mismatch");
    static_assert(offsetof(VGPUDrawIndexedIndirectCommand, baseVertex) == offsetof(D3D11_DRAW_INDEXED_INSTANCED_INDIRECT_ARGS, BaseVertexLocation), "Layout mismatch");
    static_assert(offsetof(VGPUDrawIndexedIndirectCommand, firstInstance) == offsetof(D3D11_DRAW_INDEXED_INSTANCED_INDIRECT_ARGS, StartInstanceLocation), "Layout mismatch");

    constexpr D3D11_COMPARISON_FUNC ToD3D11(VGPUCompareFunction function)
    {
        switch (function)
        {
        case VGPUCompareFunction_Never:        return D3D11_COMPARISON_NEVER;
        case VGPUCompareFunction_Less:         return D3D11_COMPARISON_LESS;
        case VGPUCompareFunction_Equal:        return D3D11_COMPARISON_EQUAL;
        case VGPUCompareFunction_LessEqual:    return D3D11_COMPARISON_LESS_EQUAL;
        case VGPUCompareFunction_Greater:      return D3D11_COMPARISON_GREATER;
        case VGPUCompareFunction_NotEqual:     return D3D11_COMPARISON_NOT_EQUAL;
        case VGPUCompareFunction_GreaterEqual: return D3D11_COMPARISON_GREATER_EQUAL;
        case VGPUCompareFunction_Always:       return D3D11_COMPARISON_ALWAYS;
    ...
    constexpr D3D11_FILTER_TYPE ToD3D11FilterType(VGPUSamplerFilter value)
    {
        switch (value)
        {
    ...
    constexpr D3D11_FILTER_TYPE ToD3D11FilterType(VGPUSamplerMipFilter value)
    {
        switch (value)
        {
    ...
    constexpr D3D11_TEXTURE_ADDRESS_MODE ToD3D11AddressMode(VGPUSamplerAddressMode mode)
    {
        switch (mode)
        {
    ...
    constexpr D3D11_BLEND D3D11Blend(VGPUBlendFactor factor)
    {
        switch (factor)
        {
        case VGPUBlendFactor_Zero:                      return D3D11_BLEND_ZERO;
        case VGPUBlendFactor_One:                       return D3D11_BLEND_ONE;
        case VGPUBlendFactor_SourceColor:               return D3D11_BLEND_SRC_COLOR;
        case VGPUBlendFactor_OneMinusSourceColor:       return D3D11_BLEND_INV_SRC_COLOR;
        case VGPUBlendFactor_SourceAlpha:               return D3D11_BLEND_SRC_ALPHA;
        case VGPUBlendFactor_OneMinusSourceAlpha:       return D3D11_BLEND_INV_SRC_ALPHA;
        case VGPUBlendFactor_DestinationColor:          return D3D11_BLEND_DEST_COLOR;
        case VGPUBlendFactor_OneMinusDestinationColor:  return D3D11_BLEND_INV_DEST_COLOR;
        case VGPUBlendFactor_DestinationAlpha:          return D3D11_BLEND_DEST_ALPHA;
        case VGPUBlendFactor_OneMinusDestinationAlpha:  return D3D11_BLEND_INV_DEST_ALPHA;
        case VGPUBlendFactor_SourceAlphaSaturated:      return D3D11_BLEND_SRC_ALPHA_SAT;
        case VGPUBlendFactor_BlendColor:                return D3D11_BLEND_BLEND_FACTOR;
        case VGPUBlendFactor_OneMinusBlendColor:        return D3D11_BLEND_INV_BLEND_FACTOR;
        //case VGPUBlendFactor_BlendAlpha:                return D3D11_BLEND_ALPHA_FACTOR;
        //case VGPUBlendFactor_OneMinusBlendAlpha:        return D3D11_BLEND_INV_ALPHA_FACTOR;
        //case VGPUBlendFactor_Source1Color:              return D3D11_BLEND_SRC1_COLOR;
        //case VGPUBlendFactor_OneMinusSource1Color:      return D3D11_BLEND_INV_SRC1_COLOR;
        //case VGPUBlendFactor_Source1Alpha:              return D3D11_BLEND_SRC1_ALPHA;
        //case VGPUBlendFactor_OneMinusSource1Alpha:      return D3D11_BLEND_INV_SRC1_ALPHA;
        default:
            return D3D11_BLEND_ZERO;
        }
    }

    constexpr D3D11_BLEND D3D11AlphaBlend(VGPUBlendFactor factor)
    {
        switch (factor)
        {
    ...
    constexpr D3D11_BLEND_OP D3D11BlendOperation(VGPUBlendOperation operation)
    {
        switch (operation)
        {
        case VGPUBlendOperation_Add:                return D3D11_BLEND_OP_ADD;
        case VGPUBlendOperation_Subtract:           return D3D11_BLEND_OP_SUBTRACT;
        case VGPUBlendOperation_ReverseSubtract:    return D3D11_BLEND_OP_REV_SUBTRACT;
        case VGPUBlendOperation_Min:                return D3D11_BLEND_OP_MIN;
        case VGPUBlendOperation_Max:                return D3D11_BLEND_OP_MAX;
        default:                                    return D3D11_BLEND_OP_ADD;
        }
    }

    constexpr uint8_t D3D11RenderTargetWriteMask(VGPUColorWriteMaskFlags writeMask)
    {
        static_assert(static_cast<UINT>(VGPUColorWriteMask_Red) == D3D11_COLOR_WRITE_ENABLE_RED);
        static_assert(static_cast<UINT>(VGPUColorWriteMask_Green) == D3D11_COLOR_WRITE_ENABLE_GREEN);
        static_assert(static_cast<UINT>(VGPUColorWriteMask_Blue) == D3D11_COLOR_WRITE_ENABLE_BLUE);
        static_assert(static_cast<UINT>(VGPUColorWriteMask_Alpha) == D3D11_COLOR_WRITE_ENABLE_ALPHA);
...
struct D3D11Shader
{
    ID3D11DeviceChild* handle = nullptr;
};
...
static VGPUPipeline* d3d12_createRenderPipeline(VGPURenderer* driverData, const VGPURenderPipelineDesc* desc)
{
    ...
    D3D12_INPUT_ELEMENT_DESC inputElementDescs[] =
    {
        ...
        { "ATTRIBUTE", 1, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 12, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 }
    };
    ...
    d3dDesc.InputLayout = { inputElementDescs, _countof(inputElementDescs) };
...
static void d3d12_setVertexBuffer(VGPUCommandBufferImpl* driverData, uint32_t index, vgpu_buffer* buffer, uint64_t offset)
{
    ...
    commandBuffer->vboViews[index].StrideInBytes = 28;
